...
exports.cadastrarProfessor = (req, res) => {
    ...
    const comando = `INSERT INTO PROFESSORES (nome, materia) VALUES
    ($1, $2);`
    const valoresDoComando = [nomeDoPostman,  materiaDoPostman]
...
exports.atualizarProfessor = (req, res) => {
    ...
    const comando = `UPDATE PROFESSORES SET nome = $1,  materia = $2 WHERE id = $3;`
